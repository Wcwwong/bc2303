...
public class Lambda2 {
  ...
  public static void main(String[] args) {
   ...
   Comparator<Staff> comparator = (s1, s2) ->{  // int compare()
       return s1.id.compareTo(s2.id);
   } ; // understood as compare s1 and s2, comparator is an interface
...
// After Lambda, approach 2
  ...
  // List of String as first input parameter
  // functional interface as input parameters
}
